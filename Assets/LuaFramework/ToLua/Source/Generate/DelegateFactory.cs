...
public class DelegateFactory
{
	...
	class GEventDispatcher_Listner_Event : LuaDelegate
	{
		public GEventDispatcher_Listner_Event(LuaFunction func) : base(func) { }
		public GEventDispatcher_Listner_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public GEventDispatcher.Listner GEventDispatcher_Listner(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
		...
		if(!flag)
		{
			GEventDispatcher_Listner_Event target = new GEventDispatcher_Listner_Event(func);
		...
		{
			GEventDispatcher_Listner_Event target = new GEventDispatcher_Listner_Event(func, self);
	...
	bool Check_GEventDispatcher_Listner(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(GEventDispatcher.Listner), L, pos);
	}

	void Push_GEventDispatcher_Listner(IntPtr L, GEventDispatcher.Listner o)
	{
		ToLua.Push(L, o);
	}
	...
	bool Check_TimerManager_OnTimer(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(TimerManager.OnTimer), L, pos);
	}
